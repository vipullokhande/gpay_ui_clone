...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Person> person = [
    Person(name: 'Melon New', bg: Colors.blue),
    Person(name: 'Laung Jui', bg: Colors.red),
    Person(name: 'Pen Diill', bg: Colors.orange),
    Person(name: 'Nont Des', bg: Colors.yellowAccent.shade700),
    Person(name: 'Akbar Homn', bg: Colors.greenAccent.shade700),
    Person(name: 'Peg New', bg: Colors.cyan),
    Person(name: 'Onbo Nob', bg: Colors.purple),
    Person(name: 'Lsg Monk', bg: Colors.blueGrey),
    Person(name: 'Worn Gui', bg: Colors.redAccent),
  ];
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          ...
          NavigationDestination(
            icon: CircleAvatar(
              radius: 15,
              child: ClipOval(child: Image.asset(assets)),
            ),
            label: "You",
          ),
        ],
